...
class Watermark_Overview {
    /**
     * Render the watermark overview.
     */
    public static function render() {
        return sprintf(
            ...
            esc_html_x( 'Watermark PDF', '', 'ilove-pdf' ),
    ...
    private static function create_files_protected() {
        return sprintf(
            ...
            39,
            esc_html_x( 'Files Protected', '', 'ilove-pdf' ),
        );
    }
    ...
    private static function create_tool_resume() {
        return sprintf(
            ...
            esc_html_x( 'total files 20 → protected files 10', '', 'ilove-pdf' ),
        );
    }
}
