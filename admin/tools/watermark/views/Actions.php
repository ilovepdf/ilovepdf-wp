...
trait Actions {
    ...
    protected function render_watermark_action( $post_id ) {
        return sprintf(
            '<a id="ipdf-action-watermark" data-post-id="%4$s" data-action="%5$s" data-nonce="%3$s" href="#" class="ipdf-btn ipdf-tooltip ipdf-btn--media-action ipdf-btn--media-action-watermark %6$s">
                %1$s
            ...
            esc_html( _x( 'Add Watermark', '', 'ilove-pdf' ) ),
