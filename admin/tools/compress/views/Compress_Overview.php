...
class Compress_Overview {
    /**
     * Render the compress overview.
     */
    public static function render() {
        return sprintf(
            ...
            esc_html_x( 'Compress PDF', '', 'ilove-pdf' ),
    ...
    private static function create_files_processed() {
        return sprintf(
            ...
            24,
            esc_html_x( 'Files Processed', '', 'ilove-pdf' ),
        );
    }
    ...
    private static function create_average_reduction() {
        return sprintf(
            ...
            '30%',
            esc_html_x( 'Average Reduction', '', 'ilove-pdf' ),
        );
    }
    ...
    private static function create_space_saved() {
        return sprintf(
            ...
            '1.2 GB',
            esc_html_x( 'Space Saved', '', 'ilove-pdf' ),
        );
    }
    ...
    private static function create_tool_resume() {
        return sprintf(
            ...
            esc_html_x( 'Original size: 230MB → Compressed: 74MB', '', 'ilove-pdf' ),
        );
    }
}
