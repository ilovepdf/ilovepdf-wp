...
trait Actions {
    ...
    protected function render_compress_action( $post_id ) {
        return sprintf(
            ...
            User_Account::is_user_logged_in() ? esc_html_x( 'Compress', 'Button action', 'ilove-pdf' ) : esc_html_x( 'Register or login with us to compress PDF', 'tooltip: Appears when the user is not logged in.', 'ilove-pdf' ),
            $post_id,
