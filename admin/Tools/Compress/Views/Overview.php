...
use Ilove_Pdf_WP\Tools\Compress\Statistics;

/**
 * Creates the HTML for the compress overview.
 *
 * @since 3.0.0
...
class Overview {
    ...
    public static function render() {
        return sprintf(
            '<article class="ilovepdf-media__overview-tool ilovepdf-media__overview-compress-overview">
                <h2 class="ilovepdf-base__layout-flex ilovepdf-base__layout-gap--small ilovepdf-base__layout-items-center">
                    %1$s
                    %2$s
                </h2>
                <div class="ilovepdf-media__overview-compress-overview-inner ilovepdf-base__layout-flex ilovepdf-base__layout-flex-wrap ilovepdf-base__layout-gap--normal">
                    %3$s
                    %4$s
                    %5$s
                </div>
    ...
    /**
     * Creates the HTML for the tool resume.
     *
     * @since 3.0.0
     * @return string
     */
    private static function create_tool_resume() {
        return sprintf(
            '<span class="ilovepdf-media__overview-subitem-resume ilovepdf-media__overview-compress-tool-resume">
                <p>%1$s</p>
            </span>',
