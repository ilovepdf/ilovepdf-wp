	...
	<div class="wrap">
        ...
        <?php if ( isset( $_GET['response_code'] ) && isset( $_GET['nonce_ilove_pdf_response'] ) && wp_verify_nonce( sanitize_key( $_GET['nonce_ilove_pdf_response'] ) ) ) : ?>
            ...
            switch ( $_GET['response_code'] ) {
                case 400:
                    echo '<div class="settings-error notice is-dismissible error"><p>' . esc_html( __( 'Bad request.' ) );
                    break;

                case 401:
                    echo '<div class="settings-error notice is-dismissible error"><p>' . esc_html( __( 'Incorrect email or password.' ) );
                    break;

                case 200:
                    echo '<div class="settings-error notice is-dismissible updated"><p>' . esc_html( __( 'Welcome!' ) );
                    break;

                case 500:
                    echo '<div class="settings-error notice is-dismissible error"><p>' . esc_html( __( 'Error on register/login.' ) );
                    break;
            }
            ?>
            </p></div>
        ...
        <h2 class="nav-tab-wrapper">
            <a href="?page=ilove-pdf-content-setting&tab=setting_options&nonce_ilove_pdf_settings_tab=<?php echo sanitize_key( $nonce_settings ); ?>" class="nav-tab <?php echo 'setting_options' === $active_tab ? 'nav-tab-active tab-ilovepdf' : ''; ?>"><?php echo esc_html( __( 'General', 'ilovepdf' ) ); ?></a>
            <a href="?page=ilove-pdf-content-setting&tab=compress_options&nonce_ilove_pdf_settings_tab=<?php echo sanitize_key( $nonce_settings ); ?>" class="nav-tab <?php echo 'compress_options' === $active_tab ? 'nav-tab-active tab-ilovepdf' : ''; ?>"><?php echo esc_html( __( 'Compress PDF', 'ilovepdf' ) ); ?></a>
            <a href="?page=ilove-pdf-content-setting&tab=watermark_options&nonce_ilove_pdf_settings_tab=<?php echo sanitize_key( $nonce_settings ); ?>" class="nav-tab <?php echo 'watermark_options' === $active_tab ? 'nav-tab-active tab-ilovepdf' : ''; ?>"><?php echo esc_html( __( 'Watermark', 'ilovepdf' ) ); ?></a>
        </h2> 	        
                        ...
                        <?php if ( get_option( 'ilovepdf_user_id' ) ) : ?>
                            ...
                            <div class="col-md-4">
                                <div class="panel" style="margin-right: 10px;">
                                    <h3><?php esc_html_e( 'Account', 'ilovepdf' ); ?></h3>
                                    <p><i class="fa fa-check" aria-hidden="true"></i> <?php esc_html_e( 'Logged as', 'ilovepdf' ); ?><strong> <?php echo esc_html( get_option( 'ilovepdf_user_email' ) ); ?></strong>&nbsp;&nbsp;&nbsp;<a href="<?php echo esc_url( add_query_arg( 'nonce_ilove_pdf_logout', wp_create_nonce( 'admin-post' ), admin_url( 'admin-post.php' ) . '?action=ilovepdf_logout' ) ); ?>" class="button button-primary" style="margin-top: 10px;"><?php esc_html_e( 'Logout', 'ilovepdf' ); ?></a></p>
                                    ...
                                    <input type="submit" class="button button-primary pull-right" value="<?php esc_html_e( 'Change Project', 'ilovepdf' ); ?>">
                                    </form>
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="panel" style="margin-left: 10px; height: 350px;">
                                    ...
                                    <?php endif; ?>
                                    <a href="https://developer.ilovepdf.com/user/account" target="_blank" class="link"><?php esc_html_e( 'Account info', 'ilovepdf' ); ?> (<?php echo esc_html( get_option( 'ilovepdf_user_email' ) ); ?>) &raquo;</a>
                        ...
                        <?php else : ?>
                            <div class="col-md-6">
                                <div class="panel" style="margin-right: 10px; height: 350px;">
                                    <h3 style="margin-bottom: 20px;"><?php esc_html_e( 'Register as iLovePDF developer', 'ilovepdf' ); ?></h3>
                                    <form method="post" id="ilovepdf_register_form" name="ilove_pdf_form_settings_section" action="">
                                        ...
                                        <p><?php esc_html_e( 'Provide your name and email address to generate keys.', 'ilovepdf' ); ?></p>
                                        <input type="text" id="ilove_pdf_account_name" name="ilove_pdf_account_name" placeholder="<?php esc_html_e( 'Name', 'ilovepdf' ); ?>"><br><br>   
                                        <input type="text" id="ilove_pdf_account_email" name="ilove_pdf_account_email" placeholder="<?php esc_html_e( 'Email', 'ilovepdf' ); ?>" value=""><br><br>   
                                        <input type="password" id="ilove_pdf_account_password" name="ilove_pdf_account_password" placeholder="<?php esc_html_e( 'Password', 'ilovepdf' ); ?>" value=""><br><br> 
                                        <input type="password" id="ilove_pdf_account_confirm_password" name="ilove_pdf_account_confirm_password" placeholder="<?php esc_html_e( 'Confirm Password', 'ilovepdf' ); ?>" value=""><span id="check_password_match"></span><br><br>   
                                        <input type="submit" class="button-primary" id="ilove_pdf_account_register" name="ilove_pdf_account_register" value="<?php esc_html_e( 'Register &amp; Generate keys', 'ilovepdf' ); ?>">  
                                    </form>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="panel" style="margin-left: 10px; height: 350px;">
                                    <h3 style="margin-bottom: 20px;"><?php esc_html_e( 'Login', 'ilovepdf' ); ?></h3>
                                    <form method="post" name="ilove_pdf_form_settings_section" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
                                        ...
                                        <p><?php esc_html_e( 'If you have an account, please log in.', 'ilovepdf' ); ?></p>
                                        <input type="text" id="ilove_pdf_account_email" name="ilove_pdf_account_email" placeholder="<?php esc_html_e( 'Email', 'ilovepdf' ); ?>" value=""><br><br>   
                                        <input type="password" id="ilove_pdf_account_password" name="ilove_pdf_account_password" placeholder="<?php esc_html_e( 'Password', 'ilovepdf' ); ?>" value=""><br><br>  
                                        <input type="submit" class="button-primary" id="ilove_pdf_account_login" name="ilove_pdf_account_login" value="<?php esc_html_e( 'Login', 'ilovepdf' ); ?>">  
                                    </form>
                                </div>
                            </div>
                                ...
                                jQuery( document ).ready( function( $ ) {
                                    $("#ilove_pdf_account_confirm_password").keyup(function(){
                                        ...
                                        if (password !==  confirmPassword){
                                            $("#check_password_match").html(" <?php esc_html_e( 'Incorrect password.', 'ilovepdf' ); ?>");
                                            $("#check_password_match").css("color","red");
                                            $("#ilovepdf_register_form").attr("action", "#");
                                        }else{
                                            $("#check_password_match").html(" <?php esc_html_e( 'Correct password.', 'ilovepdf' ); ?>");
